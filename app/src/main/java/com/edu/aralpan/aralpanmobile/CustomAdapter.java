...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvname.setText(userModelArrayList.get(position).getUser()) ;
        holder.tvscore.setText(userModelArrayList.get(position).getUser_score());
    ...
    private class ViewHolder {
        ...
        protected TextView tvname, tvmode, tvscore;
    }
